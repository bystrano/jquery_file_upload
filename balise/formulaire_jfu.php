...
function balise_FORMULAIRE_JFU ($p) {
	...
	return calculer_balise_dynamique(
		...
		'FORMULAIRE_JFU',
		array(
			'FORMULAIRE_JFU_TYPE_BOUCLE', // demande du type d'objet
			$_id_objet
		)
	);
}

function balise_FORMULAIRE_JFU_stat($args, $filtres) {
	// si on force les parametres par #FORMULAIRE_JFU{article,12,inc-upload_truc}
...
function balise_FORMULAIRE_JFU_TYPE_BOUCLE($p) {
